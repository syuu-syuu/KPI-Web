import { SiteMonthlyData } from "./columns";
...
export const siteMonthlyDataSample: SiteMonthlyData[] = [
    {
        ...
        meterPower: null,
        inverters: [
            { inverterOriginalName:"A", inverterFormattedName: "Inverter_1", value: 2.0 },
            { inverterOriginalName:"B",inverterFormattedName: "Inverter_2", value: 0.1 },
